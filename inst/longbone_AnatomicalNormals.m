...
## -*- texinfo -*-
## @deftypefn  {csg-toolkit} {[@var{transverse}, @var{coronal}] =} longbone_AnatomicalNormals (@var{v}, @var{f})
##
## Compute the normals of the transverse and coronal planes.
##
## This function returns the normals of the transverse and coronal anatomical
## planes of a longbone mesh defined by its vertices @var{v} and faces @var{f}.
##
## @seealso{longbone_AnatomicalPosition, longbone_Registration}
## @end deftypefn

function [TransPlane_normal, CorPlane_normal] = longbone_AnatomicalNormals (v, f)
